...
export const projects: Project[] = [
  {
    ...
    description: [
      ...
      "Regulatory alignment is not a feature list. It is the architecture. AwaazOnboard is designed against SBP BPRD Circular No. 1 of 2025, SBP Banking on Equality Policy 2021, National Financial Inclusion Strategy 2024–28, PTA critical infrastructure frameworks, and PDPA 2023 data protection obligations.",
    ],
    tech: [
      "Stateless VaaS",
      "Partner-embedded",
  ...
  },
  {
    ...
    tech: ["React", "Recharts", "SBP FY25 Data", "Behavioral Modeling"],
    status: "completed",
  ...
  },
  {
    ...
    status: "completed",
    demoUrl: "https://fawad-liaqat.github.io/CBDC-Design-Tradeoff-Matrix/",
  },
  {
